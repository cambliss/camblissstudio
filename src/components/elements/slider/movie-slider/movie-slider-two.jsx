...
const MovieSliderTwo = () => {
  ...
  const [manualVideos] = useState([
    "https://www.youtube.com/watch?v=HN1Dhb27oV0",
    "https://www.youtube.com/watch?v=A9Rae4VeIUQ",
    "https://www.youtube.com/watch?v=RmRRkJ3nb6U",
    "https://www.youtube.com/watch?v=HN1Dhb27oV0",
    "https://www.youtube.com/watch?v=A9Rae4VeIUQ",
    "https://www.youtube.com/watch?v=RmRRkJ3nb6U"
  ]);
      ...
      <div className="fm-movie-slider-area fm-movie-pad">
        <div className="fm-movie-slider-wrapper wow fadeInUp" data-wow-delay="0.3s">
          <div className="fm-movie-slider-active">
            ...
            >
              {manualVideos.map((url, index) => (
                <SwiperSlide key={index}>
                  <div className="fm-movie-slider-single">
                    {/* You can add your video content here */}
                    <button className="popup-video" onClick={() => openVideoModal(url)}>
                      <span className="movie-video-button"><i className="fa-thin fa-play"></i></span>
                      WATCH NOW
                    </button>
                  </div>
                </SwiperSlide>
