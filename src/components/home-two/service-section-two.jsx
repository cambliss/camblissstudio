...
const manuallyWrittenServices = [
  ...
  },
  {
    link: "/branding",
    serviceNum: "02",
    image: "assets/img/services/branding.png",
    title: "Branding & Creative Services",
    description: "Our branding is collaborative, capturing your vision.",
    delay: "0.4s",
  },
  {
    link: "/Animation",
    serviceNum: "03",
    image: "assets/img/services/animation.png",
    title: "Animation",
    description: "We create captivating 2D & 3D animations to bring your vision to life.",
    delay: "0.5s",
  },
  {
    link: "/UI-UX",
    serviceNum: "04",
    image: "assets/img/services/uiux.png",
    title: "UI/UX",
    description: "Cambliss specializes in UI/UX, where your functionality meets aesthetics.",
    delay: "0.6s",
  },
  {
    link: "/Advertisement",
    serviceNum: "06",
    image: "assets/img/services/adv.png",
    title: "Advertisement",
    description: "Elevate Your Experience, Embrace the Extraordinary.",
    delay: "0.6s",
  },
  {
    link: "/InteriorDesigning",
    serviceNum: "07",
    image: "assets/img/services/interior.png",
    title: "Interior Designing",
    description: "Where Style Meets Comfort, Your Space Unveiled.",
    delay: "0.6s",
  },
  {
    link: "/Visual-Production",
    serviceNum: "08",
    image: "assets/img/services/visualprod.png",
    title: "Visual Production",
    description: "Unleash the power of visuals with our production services.",
    delay: "0.6s",
  },
  {
    link: "/IBS",
    serviceNum: "09",
    image: "assets/img/services/isb.png",
    title: "Integrated Cloud Business Solutions",
    description: "Cambliss IBS delivers software suites to solve critical business challenges.",
    delay: "0.6s",
  },
];
